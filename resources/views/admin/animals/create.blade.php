            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ isset($animal) ? 'Edit Animal' : 'Add New Animal' }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ isset($animal) ? route('animals.update', $animal->id) : route('animals.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if(isset($animal))
                                @method('PUT')
                            @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('sale_type') is-invalid @enderror" 
                                                id="sale_type" name="sale_type" required>
                                            <option value="fixed" {{ old('sale_type', $animal->sale_type ?? '') == 'fixed' ? 'selected' : '' }}>Fixed Price</option>
                                            <option value="auction" {{ old('sale_type', $animal->sale_type ?? '') == 'auction' ? 'selected' : '' }}>Auction</option>
                                            <option value="group" {{ old('sale_type', $animal->sale_type ?? '') == 'group' ? 'selected' : '' }}>Group Sale</option>
                                        </select>
                                        @error('sale_type')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('gender') is-invalid @enderror" 
                                            ...
                                            <option value="other" {{ old('gender', $animal->gender ?? '') == 'other' ? 'selected' : '' }}>Other</option>
                                        </select>
                                        @error('gender')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" 
                                            ...
                                            <option value="not_for_sale" {{ old('status', $animal->status ?? '') == 'not_for_sale' ? 'selected' : '' }}>Not for Sale</option>
                                            <option value="expired" {{ old('status', $animal->status ?? '') == 'expired' ? 'selected' : '' }}>Expired</option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('health_info') is-invalid @enderror" 
                                          id="health_info" name="health_info" 
                                          rows="3">{{ old('health_info', $animal->health_info ?? '') }}</textarea>
                                @error('health_info')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('feed_details') is-invalid @enderror" 
                                          id="feed_details" name="feed_details" 
                                          rows="3">{{ old('feed_details', $animal->feed_details ?? '') }}</textarea>
                                @error('feed_details')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
